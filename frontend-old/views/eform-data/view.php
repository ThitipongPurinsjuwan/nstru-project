...
<div class="eform-data-view">
        ...
        ?>
                <div class="card-body">
                    ...
                    <div class="row">
                        ...
                        <div class="col-5 py-1"><strong>รหัสประจำตัวสายข่าว:</strong></div>
                        <div class="col-7 py-1"><?=$undercover['undercover_number'];?></div>
                        <div class="col-5 py-1"><strong>ชื่อสายข่าว:</strong></div>
                        <div class="col-7 py-1"><?=$undercover['name'];?></div>
                        <div class="col-5 py-1"><strong>หน่วยงาน:</strong></div>
                        <div class="col-7 py-1"><?=$unit['unit_name'];?></div>
                        <div class="col-5 py-1"><strong>สถานะการทำงาน:</strong></div>
                        ...
                        ?></div>
                        <div class="col-5 py-1"><strong>ที่อยู่:</strong></div>
                        <div class="col-7 py-1"><?=$undercover['address'];?></div>
                        <div class="col-5 py-1"><strong>อีเมล:</strong></div>
                        <div class="col-7 py-1"><?=$undercover['email'];?></div>
                        <div class="col-5 py-1"><strong>เบอร์โทรศัพท์:</strong></div>
                        ...
                        <div class="col-7 py-1">
                            <a href="index.php?r=undercover/view&id=<?php echo $undercover['id'];?>" target="_blank"
                                class="btn btn-outline-dark btn-sm text-nowrap" role="button"><i
                                    class="fas fa-user"></i> รายละเอียดเพิ่มเติม</a>
                        </div>
            ...
            <div class="card card-collapsed">
                ...
                <div class="card-header">
                    <h3 class="card-title">
                        <dt>รายละเอียดการแก้ไขและการเรียกดูข้อมูล</dt>
                    </h3>
                    <div class="card-options">
    ...
    <p>
        <a class="btn btn-primary"
            href="index.php?r=site/pages&view=eform_information&eform_data=<?=$model->id;?>">แก้ไขข้อมูล</a>
        ...
        <a href="index.php?r=eform-data/print-report-record&id=<?=$model->id;?>&printnow=true" target="_blank"
            class="btn btn-success" role="button"><i class="fas fa-print"></i> พิมพ์รายงาน</a>
    </p>
