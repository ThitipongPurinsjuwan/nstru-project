...
if ($type=='view_equipment') {
	...
	foreach ($result as $row) {
		...
		$resultArray[] = array(
			...
			'link' => '<a href="index.php?r=equipment/equipment-views&id='.$row['id'].'" class="btn btn-primary btn-xs"><i class="fa fa-search"></i></a> 
			<a href="index.php?r=equipment/update&id='.$row['id'].'"  class="btn btn-primary btn-xs"><i class="icon-note"></i></a>'
		);
