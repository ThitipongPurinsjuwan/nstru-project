    ...
    <div class="tab-pane fade show active" id="Report-Invoices" role="tabpanel">
        <div class="row">
            ...
            <div class="col-lg-3 col-md-6">
                <div class="card">
                    <div class="card-body">
                        <div class="card-value float-right text-request-new"><i class="fa fa-question-circle-o"></i>
                        </div>
        ...
        <div class="card card-maroon">
            <div class="card-body">
                ...
                <div class="table-responsive">
                    ...
                    <div class="row">
                        <div class="col-md-12 mb-1 text-right" style="font-size: 14px;">
                        <dt>
                        <span class="tag tag-success" style="margin-right: 2px; margin-left: 5px;">
                            </span> อนุมัติแล้ว 
                            <span class="tag tag-danger" style="margin-right: 2px; margin-left: 5px;">
                            </span> รอการอนุมัติ
                            <span class="tag tag-warning" style="margin-right: 2px; margin-left: 5px;">
                            </span> ต้องการข้อมูลเพิ่มเติม
                            <span class="tag tag-primary" style="margin-right: 2px; margin-left: 5px;">
                            </span> ประเมินข่าว </dt>
                            <!-- <span class="badge badge-pill badge-success"><i class="fe fe-check-circle"
                                    data-toggle="tooltip" style="margin-top: 9px;"></i> อนุมัติแล้ว </span>
                            <span class="badge badge-pill badge-danger"><i class="fe fe-alert-circle"
                                    data-toggle="tooltip" style="margin-top: 9px;"></i> รอการอนุมัติ </span>
                            <span class="badge badge-pill badge-warning"><i class="fa fa-question-circle-o"
                                    data-toggle="tooltip" style="margin-top: 9px;"></i> ต้องการข้อมูลเพิ่มเติม </span>
                            <span class="badge badge-pill badge-primary"><i class="fe fe-file-text"
                                    data-toggle="tooltip" style="margin-top: 9px;"></i> ประเมินข่าว </span> -->
                        </div>
                    </div>
                ...
                success: function(data) {
                    ...
                    var result = data.filter(function(el, i, x) {
                        return x.some(function(obj, j) {
                            return obj.select_approve === el.select_approve && (
                                x = j);
                        }) && i == x;
                    });
