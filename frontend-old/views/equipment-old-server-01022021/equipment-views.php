		...
		<div class="card">
			<div class="card-body card-height ribbon">
				...
				<a href="javascript:void(0)" class="my_sort_cut text-muted" data-toggle="modal" data-target="#addprosn">
					...
					<span>เพิ่มข้อมูลหมายเลขอุปกรณ์</span>
				</a>
			</div>
		</div>
	</div>
	<div class="col-6 col-md-4 col-xl-2">
		<div class="card">
			<div class="card-body card-height ribbon">
				...
				<div class="ribbon-box indigo"><?=$count_equipment_sn;?></div>
				<a href="javascript:void(0)" class="my_sort_cut text-muted">
					<i class="icon-drawer"></i>
					<span>จำนวนเครื่องทั้งหมด (<?php echo $equipment['pronoun']; ?>)</span>
				</a>
			</div>
		</div>
	</div>
	<div class="col-6 col-md-4 col-xl-2">
		<div class="card">
			<div class="card-body card-height ribbon">
				...
				<div class="ribbon-box pink"><?=$count_equipment_dis;?></div>
				<a href="javascript:void(0)" class="my_sort_cut text-muted">
					<i class="icon-equalizer"></i>
					<span>อยู่ในระหว่างการเบิกจ่าย (<?php echo $equipment['pronoun']; ?>)</span>
				</a>
			</div>
		</div>
	</div>
