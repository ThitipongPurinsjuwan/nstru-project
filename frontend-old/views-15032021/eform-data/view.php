...
<div class="col-md-4">
  ...
  <?php if ($_SESSION['user_role']=='3'): ?>
    <p>
      ...
      <a href="index.php?r=eform-data/print-report-record&id=<?=$model->id;?>&printnow=true" target="_blank" class="btn btn-success" role="button"><i class="fas fa-print"></i> พิมพ์รายงาน</a>
    </p>
