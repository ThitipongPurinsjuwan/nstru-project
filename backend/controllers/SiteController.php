...
class SiteController extends Controller
{
  ...
  public function actionIndex()
  {
    ...
    public function actionJsonNotification()
    {
        $this->layout = false;
        return $this->render('json-notification');
    }
    ...
    public function actionJson_stat_undercover()
    {
        $this->layout = false;
        return $this->render('json_stat_undercover');
    }

    public function actionLinkTimelineUndercover()
    {
        $this->layout = false;
        return $this->render('link-timeline-undercover');
    }
    ...
    public function actionJsonTimelineUndercover()
    {
        $this->layout = false;
        return $this->render('json-timeline-undercover');
    }
    ...
    public function actionJson_words_cut()
    {
        $this->layout = false;
        return $this->render('json_words_cut');
    }
     public function actionPageUploadfile()
    {
        $this->layout = false;
        return $this->render('page-uploadfile');
    } 

     public function actionPageAjaxuploadfile()
    {
        $this->layout = false;
        return $this->render('page-ajaxuploadfile');
    } 
    
     public function actionTestcode()
    {
        $this->layout = false;
        return $this->render('testcode');
    } 
