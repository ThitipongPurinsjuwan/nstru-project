...
/**
 * PublicRelationsSearch represents the model behind the search form of `app\models\PublicRelations`.
 */
class PublicRelationsSearch extends PublicRelations
{
    ...
    public function rules()
    {
        return [
            ...
            [['topic', 'details', 'date_imparting', 'key_images', 'date_create'], 'safe'],
        ];
    }
