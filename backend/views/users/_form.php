...
<div class="users-form">
    ...
    <div class="row">
        ...
        <?php echo $form->field($model, 'role')->hiddenInput(['maxlength' => true,'value'=>'2'])->label(false); 
                      echo $form->field($model, 'unit_id')->hiddenInput(['maxlength' => true, 'value'=>'1'])->label(false); 
                        echo $form->field($model, 'user_group')->hiddenInput(['maxlength' => true, 'value'=>''])->label(false); 
                    ?>
    ...
    <div class="row">
        <div class="col-md-4">
          <?=$form->field($model, 'notification')->hiddenInput(['value' => '0'])->label(false); ?>
