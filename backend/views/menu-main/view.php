                     ...
                     <div class="col-md-8">
                        ...
                        <div id="manage_sort">
                            ...
                            <ul id="sortable-row" class="sortable-all" style="padding: 0;" >
                                <?php $result_sub = Yii::$app->db->createCommand("SELECT * FROM menu_sub WHERE  menu_id = '".$_GET["id"]."' ORDER BY submenu_sort ASC")->queryAll();  // submenu_active = 'Y' AND
                                    ...
                                    <li class="sub menu-slot" id="<?php echo $row_sub["submenu_id"]; ?>">
                                        <div class="menu-slot-left">
                                           <i class="<?php echo $row_sub["s_icon"]; ?>"></i>
                                            <?php echo $row_sub["submenu_name"]; ?>  <?php echo $row_sub["submenu_active"] == 'N' ?  ' [Disable]' : '' ; ?>
                                        </div>
