        ...
        <div class="col-xl-12 col-lg-12 col-md-12">
            <div class="card  card-primary ">
                <div class="card-body ribbon">
                    ...
                    <p class="text-right">
                        <?= Html::a(Yii::t('app', '<i class="fe fe-plus" data-toggle="tooltip" title="" data-original-title="fe fe-plus"></i> เพิ่มเมนูหลัก'), ['create'], ['class' => 'btn btn-success']) ?>
                        <?= Html::a(Yii::t('app', 'จัดการสิทธิ์การเข้าถึงเมนู'), ['user-role/update','id'=>'1'], ['class' => 'btn btn-success']) ?>
                    </p>
                                ...
                                <ul id="sortable-row" style="padding: 0;">
                                    ...
                                    <li id="<?php echo $row["id"]; ?>" class="menu-slot">
                                        ...
                                        <div class="menu-slot-right">
                                            ...
                                            <a href="index.php?r=menu-main%2Fdelete&amp;id=<?php echo $row["id"]; ?>"
