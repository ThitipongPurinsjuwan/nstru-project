            ...
            <div class="card card-info">
                <div class="card-body ribbon">
                    <p align="right">
                        ...
                        <!-- --> <a  onClick="extractText('<?=$model->id?>','<?=$model->file_name;?>','<?=$model->bucket;?>');" href="#extract"   class="btn  btn-primary" ><i class="fa fa-file"></i> ประมวลผลใหม่</a> 

                        <!-- href="index.php?r=file-upload-list/manage_words&id=<?=$model->id;?>" -->
                        <a href="index.php?r=file-upload-list/words_cut&id=<?=$model->id;?>" class="btn  btn-primary" ><i class="fa fa-cut"></i> ตัดคำ</a>
