        ...
        <div class="row">
            ...
            <div class="col-lg-3 col-md-6">
                <div class="card card-warning">
                    <div class="card-status card-status-left bg-yellow"></div>
                    <div class="card-body">
        ...
        <div class="row">
            <div class="col-md-12">
                ...
                <div style="float:right;">
                    ...
                    <div class="dropdown">
                        <button class="btn btn-lg btn-primary dropdown-toggle" type="button" id="dropdownMenuButton"
                        ...
                        <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                            ...
                            <a class="dropdown-item"
                                href="index.php?r=site/pages&view=process_news&form_id=<?=$s->id?>"><?=$s->detail?></a>
                ...
                <div class="card card-warning">
                    ...
                    <div class="card-body">
                        <div class="table-responsive">
                            ...
                            <div><strong>รายการสรุปข่าวประจำวัน (ข้อมูลวันที่
                                    <?php echo dateThai(date("Y-m-d")); ?>)</strong></div><br>
                ...
                <div class="card card-warning">
                    ...
                    <div class="card-body">
                        <div class="table-responsive">
                            ...
                            <div class="card-value float-right text-azure-new"><i class="fe fe-folder"></i></div>
                            <div><strong>รายการสรุปข่าวกรอง (ข้อมูลวันที่
                                    <?php echo dateThai(date("Y-m-d")); ?>)</strong></div><br>
            ...
            success: function(data) {
                ...
                if (data.length > 0) {
                    ...
                    for (i = 0; i < data.length; i++) {
                        ...
                        array_data.push(
                            `<div class="col-md-12 card card-news"><a href="index.php?r=eform-data/view-process&id=${link}" class="link-to-view"><div class="row"><div class="col-md-1">${no}</div><div class="col-md-11">${detail}</div><div class="col-md-1"></div><div class="col-md-11">ส่งถึงหน่วย : ${tounit}</div></div></a></div>`
                            );
                    ...
                    $("#show-btn-etc").html(
                        `<button class="btn btn-primary">ข้อมูลทั้งหมด</button>`);
