...
<div class="eform-template-index">
    ...
    <div class="row clearfix">
            ...
            <div class="card card-success">
                <div class="card-body ribbon">
                    ...
                    <!-- <a href="index.php?r=user-role" class="my_sort_cut text-muted"> -->
                        ...
                        <h4><?=$count_user_role;?></h4>
                        <span>กลุ่มผู้ใช้งานแบบฟอร์ม</span>
                        <br>
                    <!-- </a> -->
                </div>
            </div>
        ...
        <div class="col-md-12 col-md-4 col-xl-8 text-right">
            <a class="btn btn-success" href="index.php?r=eform-template/create"> <i class="fe fe-plus"
                    data-toggle="tooltip" title="" data-original-title="fe fe-plus"></i> สร้างแบบฟอร์ม [ต้นแบบ]</a>
            ...
            <div class="card card-success">
                <div class="card-header">
                    ...
                    ?>
                        ...
                        <a class="btn-question goDoSomething" id="desc-model" data-id-desc="<?=$desc_modal['id'];?>"
                            data-toggle="modal" data-target=".bd-modal-manual">
