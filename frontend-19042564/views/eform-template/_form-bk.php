			...
			<div class="form-group">
				...
				<div class="selectgroup w-100 row" style="padding-left: 0.5em !important;">
					...
					<label class="selectgroup-item">
							...
							<span class="selectgroup-button" style="white-space: nowrap !important;">ไม่มีการอนุมัตข่าว</span>
						</label>
	...
	(function($) {
		$(document).ready(function(){
			...
			function loadData(objdata_nosort){
				...
				var text = '<button type="button" class="btn btn-primary savesort">บันทึการเรียงลำดับ</button><button type="button" class="btn btn-primary show_data">เพิ่มช่องกรอกข้อมูลใหม่</button><ul id="sortable-row" class="sortable-all" style="padding: 0;"><br>';
...
$(document).on('click', '.savesort', function(){
	...
	$('ul.sortable-all li.menu-slot').each(function() {
		// selectedLanguage.push($(this).data("sort"));
