        ...
        <div class="col-xl-12 col-lg-12 col-md-12">
            <div class="card  card-primary ">
                <div class="card-body ribbon">
                    ...
                    <p class="text-right">
                        <?= Html::a(Yii::t('app', '<i class="fe fe-plus" data-toggle="tooltip" title="" data-original-title="fe fe-plus"></i> เพิ่มสไลด์ข่าวหน้าเข้าสู่ระบบ'), ['create'], ['class' => 'btn btn-success']) ?>
                    </p>
                    ...
                    <div class="row">
                        <div class="col-md-8">
                            ...
                            <div id="manage_sort">
                                ...
                                <ul id="sortable-row" style="padding: 0;">
                                    ...
                                    <li id="<?php echo $row["id"]; ?>" class="menu-slot">
                                        ...
                                        <div class="menu-slot-right">
                                            ...
                                            <a
                                                href="index.php?r=carousel-text%2Fupdate&amp;id=<?php echo $row["id"]; ?>">
                                                <span class="glyphicon glyphicon-pencil"></span>
                                            </a>
                                            <a href="index.php?r=carousel-text%2Fdelete&amp;id=<?php echo $row["id"]; ?>"
                                                data-confirm=" ต้องยกเลิกเมนูใช่หรือไม่?" data-method="post"
                                                data-title="Delete">
                                ...
                                <input type="submit" class="btn btn-primary" value="บันทึกการเรียงลำดับ"
                                    onClick="saveOrder();" style="margin: 0;" />
                            </div>
                            <?php ActiveForm::end(); ?>
                        </div>
                    </div>
