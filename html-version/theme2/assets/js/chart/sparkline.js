...
function drawDocSparklines() {
    ...
    $('#compositebar').sparkline('html', { type: 'bar', barColor: '#7d8490' });
    ...
    $('.sparkbar').sparkline('html', { type: 'bar', barColor: '#7d8490' });
    ...
    $('.sparktristatecols').sparkline('html',
        { type: 'tristate', colorMap: { '-2': '#fa7', '2': '#1b6079' } });
    ...
    $('#normalExample').sparkline('html',
        { fillColor: false, normalRangeMin: 80, normalRangeMax: 95, normalRangeColor: '#1b6079' });
