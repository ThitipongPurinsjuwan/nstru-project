		...
		sass: {			
            dist: {
                ...
                files: [{
                    ...
                    'assets/css/dark.css':              'assets/scss/skins/dark.scss',                      /* 'Theme SCSS to css path' */
                    'assets/css/theme1.css':            'assets/scss/skins/theme1.scss',                    /* 'Theme SCSS to css path' */                    
                    'assets/css/theme2.css':            'assets/scss/skins/theme2.scss',                    /* 'Theme SCSS to css path' */
                    'assets/css/theme3.css':            'assets/scss/skins/theme3.scss',                    /* 'Theme SCSS to css path' */
                    'assets/css/theme4.css':            'assets/scss/skins/theme4.scss',                    /* 'Theme SCSS to css path' */
                    'assets/css/theme5.css':            'assets/scss/skins/theme5.scss',                    /* 'Theme SCSS to css path' */
