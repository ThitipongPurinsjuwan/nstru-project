    ...
    T.ajaxSetup({
        ...
        setOffset: function(e, t, n) {
            var i, r, o, s, a, l, u = T.css(e, "position"),
                c = T(e),
                h = {};
            "static" === u && (e.style.position = "relative"), a = c.offset(), o = T.css(e, "top"), l = T.css(e, "left"), ("absolute" === u || "fixed" === u) && -1 < (o + l).indexOf("auto") ? (s = (i = c.position()).top, r = i.left) : (s = parseFloat(o) || 0, r = parseFloat(l) || 0), y(t) && (t = t.call(e, n, T.extend({}, a))), null != t.top && (h.top = t.top - a.top + s), null != t.left && (h.left = t.left - a.left + r), "using" in t ? t.using.call(e, h) : c.css(h)
        }
    }, T.fn.extend({
        offset: function(t) {
        ...
        e = function() {
            ...
            renderRegion: function(e, t) {
                var n, i, r, o, s, a, l = this.values,
                    u = this.options,
                    c = this.target;
                if (n = c.pixelHeight, r = B.round(n / 2), o = e * this.totalBarWidth, l[e] < 0 ? i = (s = r) - 1 : 0 < l[e] ? (s = 0, i = r - 1) : (s = r - 1, i = 2), null !== (a = this.calcColor(l[e], e))) return t && (a = this.calcHighlightColor(a, u)), c.drawRect(o, s, this.barWidth - 1, i - 1, a, a)
            }
