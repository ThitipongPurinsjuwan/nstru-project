...
$(document).ready(function() {
    ...
    var chart = new ApexCharts(
        document.querySelector("#User_Statistics"),
        options
    );
    chart.render();
...
$(document).ready(function() {
    var options = {
        ...
        colors: ['#e4bd51', '#18BADD', '#6c7989', '#9aa2ac'],
        plotOptions: {
            radialBar: {
                dataLabels: {
                    name: {
        ...
        series: [44, 55, 67, 83],
        labels: ['America', 'Canada', 'India', 'UK'],        
    }
    var chart = new ApexCharts(
...
$(document).ready(function() {
    ...
    var chart = new ApexCharts(
        document.querySelector("#apex-Gender-Overview"),
        options
    );
