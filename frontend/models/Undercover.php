...
class Undercover extends \yii\db\ActiveRecord
{
    ...
    {
        return [
            [['undercover_number', 'name', 'unitid', 'status', 'email', 'address', 'phone'], 'required'],
            [['unitid','trust'], 'integer'],
    ...
    public function attributeLabels()
    {
        return [
            'id' => Yii::t('app', 'รหัส'),
            'undercover_number' => Yii::t('app', 'รหัสประจำตัว'),
            'name' => Yii::t('app', 'ชื่อ'),
            ...
            'trust' => Yii::t('app', 'ระดับความน่าเชื่อถือ'),
