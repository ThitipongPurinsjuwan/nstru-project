                ...
                <div class="card-body w_sparkline">
                    <div class="details">
                        ...
                        <h3 class="mb-0 counter">
                            <?=$admin = Yii::$app->db->createCommand("SELECT COUNT(*) FROM users WHERE role = '2' AND unit_id = '".$_GET['unitid']."'")->queryScalar();?>
                        </h3>
                        <?php else: ?>
            ...
            <div class="card  card-info ">
                <div class="card-body ribbon">
                    <p class="text-right">
                        ...
                        <?= Html::a('<i class="fe fe-plus" data-toggle="tooltip" title="" data-original-title="fe fe-plus"></i> เพิ่มผู้ใช้งานในหน่วย', ['create_users','unitid'=>$_GET['unitid'],'unitname'=>$UnitName['unit_name']], ['class' => 'btn btn-success']) ?>
                        <?= Html::a('<i class="fe fe-plus" data-toggle="tooltip" title="" data-original-title="fe fe-plus"></i> เพิ่มสายข่าวในหน่วย', ['undercover/create_undercover','unitid'=>$_GET['unitid'],'unitname'=>$UnitName['unit_name']], ['class' => 'btn btn-success']) ?>
                        <?php else: ?>
                        <?= Html::a('<i class="fe fe-plus" data-toggle="tooltip" title="" data-original-title="fe fe-plus"></i> เพิ่มผู้ใช้งานในหน่วย', ['create_users'], ['class' => 'btn btn-success']) ?>
                        <?= Html::a('<i class="fe fe-plus" data-toggle="tooltip" title="" data-original-title="fe fe-plus"></i> เพิ่มสายข่าวในหน่วย', ['undercover/create_undercover'], ['class' => 'btn btn-success']) ?>
                        <?php endif ?>
                        <?php else: ?>
                        <?= Html::a('<i class="fe fe-plus" data-toggle="tooltip" title="" data-original-title="fe fe-plus"></i> เพิ่มผู้ใช้งานระบบ', ['create'], ['class' => 'btn btn-success']) ?>
                        <?php endif ?>
                    </p>
