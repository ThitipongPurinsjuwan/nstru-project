...
<head>
    ...
    <link rel="stylesheet" type="text/css"
        href="../../themes/template/assets/vendor/bootstrap-icons/bootstrap-icons.css">
...
<body>
    ...
    <div class="alert alert-warning py-2 m-0 bg-primary border-0 rounded-0 alert-dismissible fade show text-center overflow-hidden"
        ...
        <!-- <div class="position-relative">
            <p class="text-white m-0">Unlimited download! Starting from just $15/m <a href="#"
                    class="btn btn-xs btn-dark ms-3 mb-0">Grab now!</a></p>
        </div> -->
        <!-- Close button -->
            ...
            <div class="container">
                <div class="d-md-flex justify-content-between align-items-center my-2">
                    ...
                    <ul class="nav">
                        ...
                        <li class="nav-item">
                            <a class="nav-link" href="index.php?r=site/logout_clear">ออกจากระบบ</a>
                        </li>
                    </ul>
                    <!-- Top bar right -->
        ...
        <nav class="navbar navbar-expand-lg">
            <div class="container">
                ...
                <a class="navbar-brand" href="index.php">
                    ...
                    <img class="navbar-brand-item light-mode-item" src="../../themes/template/assets/images/logo.svg"
                        alt="logo">
                    <img class="navbar-brand-item dark-mode-item"
                        src="../../themes/template/assets/images/logo-light.svg" alt="logo">
                </a>
                ...
                <div class="collapse navbar-collapse" id="navbarCollapse">
                    <ul class="navbar-nav navbar-nav-scroll mx-auto">
                        ...
                        <li class="nav-item">
                            <a class="nav-link" href="<?=$val_menu_main['m_link']?>"><i
                                    class="<?=$val_menu_main['m_icon'];?>"></i><?=$val_menu_main['m_name'];?></a>
                        </li>
                        <?php else: ?>

                        <?php if ($val_menu_main['m_type']!='left_side'): ?>
                        <li class="nav-item"><a class="nav-link"
                                href="index.php?r=site/pages&view=menu-center&mainid=<?=$val_menu_main['id'];?>"><i
                                    class="<?=$val_menu_main['m_icon'];?>"></i><?=$val_menu_main['m_name'];?></a></li>
                        <?php else: ?>
                        ...
                        ?>
                        <li
                            class=" nav-item dropdown <?php if($val_menu_main['id'] == $activeMenu['id']){echo 'active'; }else { echo ''; } ?>">
                            <a href="javascript:void(0)" class="nav-link dropdown-toggle" aria-expanded="false"
                                id="<?=$val_menu_main['id'];?>"><i
                                    class="<?=$val_menu_main['m_icon'];?>"></i><?=$val_menu_main['m_name'];?></a>
                            <ul aria-expanded="true" class="dropdown-menu" aria-labelledby="<?=$val_menu_main['id'];?>">
                                ...
                                ?>
                                <li
                                    class="<?php if($val_menu_sub['submenu_id'] == $activeMenu['submenu_id']){echo 'active-sub'; }else { echo ''; } ?>">
                ...
                <div class="nav flex-nowrap align-items-center">
                    ...
                    <div class="nav-item d-none d-md-block">
                        <a href="index.php?r=site/logout_clear" class="btn btn-sm btn-danger mb-0 mx-2">ออกจากระบบ</a>
                    </div>
                    <!-- Nav Search -->
                        ...
                        <div data-sticky data-margin-top="80" data-sticky-for="767">
                            ...
                            <div>
                                ...
                                <div class="text-center mb-3 card-bg-scale position-relative overflow-hidden rounded bg-dark-overlay-4 "
                                    style="background-image:url(../../themes/template/assets/images/blog/4by3/01.jpg); background-position: center left; background-size: cover;">
                                    <div class="p-3">
                                ...
                                <div class="text-center mb-3 card-bg-scale position-relative overflow-hidden rounded"
                                    style="background-image:url(../../themes/template/assets/images/blog/4by3/02.jpg); background-position: center left; background-size: cover;">
                                ...
                                <!-- Category item -->
                                <div class="text-center mb-3 card-bg-scale position-relative overflow-hidden rounded"
                                    style="background-image:url(../../themes/template/assets/images/blog/4by3/03.jpg); background-position: center left; background-size: cover;">
                                    <div class="bg-dark-overlay-4 p-3">
                                ...
                                <!-- Category item -->
                                <div class="text-center mb-3 card-bg-scale position-relative overflow-hidden rounded"
                                    style="background-image:url(../../themes/template/assets/images/blog/4by3/04.jpg); background-position: center left; background-size: cover;">
                                    <div class="bg-dark-overlay-4 p-3">
                                        <a href="#"
                                ...
                                <!-- Category item -->
                                <div class="text-center mb-3 card-bg-scale position-relative overflow-hidden rounded"
                                    style="background-image:url(../../themes/template/assets/images/blog/4by3/05.jpg); background-position: center left; background-size: cover;">
                                    <div class="bg-dark-overlay-4 p-3">
                                ...
                                <div class="col-12 col-sm-6 col-lg-12">
                                    ...
                                    <div class="card mb-3">
                                        <div class="row g-3">
                                            <div class="col-4">
                                                <img class="rounded"
                                                    src="../../themes/template/assets/images/blog/4by3/thumb/01.jpg"
                                                    alt="">
                                            </div>
                                            <div class="col-8">
                                    ...
                                    <div class="card mb-3">
                                        <div class="row g-3">
                                            <div class="col-4">
                                                <img class="rounded"
                                                    src="../../themes/template/assets/images/blog/4by3/thumb/02.jpg"
                                                    alt="">
                                            </div>
                                            <div class="col-8">
                                                <h6><a href="post-single-2.html"
                                    ...
                                    <div class="card mb-3">
                                        <div class="row g-3">
                                            <div class="col-4">
                                                <img class="rounded"
                                                    src="../../themes/template/assets/images/blog/4by3/thumb/03.jpg"
                                                    alt="">
                                            </div>
                                            <div class="col-8">
                                                <h6><a href="post-single-2.html"
                                    ...
                                    <div class="card mb-3">
                                        <div class="row g-3">
                                            <div class="col-4">
                                                <img class="rounded"
                                                    src="../../themes/template/assets/images/blog/4by3/thumb/04.jpg"
                                                    alt="">
                                            </div>
                                            <div class="col-8">
                                                <h6><a href="post-single-2.html"
                        ...
                        <div class="tiny-slider arrow-hover arrow-blur arrow-dark arrow-round">
                            <div class="tiny-slider-inner" data-autoplay="true" data-hoverpause="true" data-gutter="24"
                                ...
                                <div class="card">
                                    <!-- Card img -->
                                    <div class="position-relative">
                                        <img class="card-img" src="../../themes/template/assets/images/blog/4by3/07.jpg"
                                            alt="Card image">
                                                    ...
                                                    <div class="d-flex align-items-center position-relative">
                                                        <div class="avatar avatar-xs">
                                                            <img class="avatar-img rounded-circle"
                                                                src="../../themes/template/assets/images/avatar/07.jpg"
                                                                alt="avatar">
                                                        </div>
                                ...
                                <div class="card">
                                    <!-- Card img -->
                                    <div class="position-relative">
                                        <img class="card-img" src="../../themes/template/assets/images/blog/4by3/08.jpg"
                                            alt="Card image">
                                        <div class="card-img-overlay d-flex align-items-start flex-column p-3">
                                            <!-- Card overlay bottom -->
                                            <div class="w-100 mt-auto">
                                ...
                                <div class="card">
                                    <!-- Card img -->
                                    <div class="position-relative">
                                        <img class="card-img" src="../../themes/template/assets/images/blog/4by3/09.jpg"
                                            alt="Card image">
                                        <div class="card-img-overlay d-flex align-items-start flex-column p-3">
                                            <!-- Card overlay bottom -->
                                            <div class="w-100 mt-auto">
                                            ...
                                            <li class="nav-item">
                                                <div class="nav-link">
                                                    <div class="d-flex align-items-center position-relative">
                                                        <div class="avatar avatar-xs">
                                                            <img class="avatar-img rounded-circle"
                                                                src="../../themes/template/assets/images/avatar/09.jpg"
                                                                alt="avatar">
                                                        </div>
                                                        <span class="ms-3">by <a href="#"
                                ...
                                <div class="card">
                                    <!-- Card img -->
                                    <div class="position-relative">
                                        <img class="card-img" src="../../themes/template/assets/images/blog/4by3/10.jpg"
                                            alt="Card image">
                                        <div class="card-img-overlay d-flex align-items-start flex-column p-3">
                                            <!-- Card overlay Top -->
                                            <div class="w-100 mb-auto d-flex justify-content-end">
                                            ...
                                            <li class="nav-item">
                                                <div class="nav-link">
                                                    <div class="d-flex align-items-center position-relative">
                                                        <div class="avatar avatar-xs">
                                                            <img class="avatar-img rounded-circle"
                                                                src="../../themes/template/assets/images/avatar/10.jpg"
                                                                alt="avatar">
                                                        </div>
                                                        <span class="ms-3">by <a href="#"
                                ...
                                <div class="card">
                                    <!-- Card img -->
                                    <div class="position-relative">
                                        <img class="card-img" src="../../themes/template/assets/images/blog/4by3/11.jpg"
                                            alt="Card image">
                                        <div class="card-img-overlay d-flex align-items-start flex-column p-3">
                                            <!-- Card overlay bottom -->
                                            <div class="w-100 mt-auto">
                                            ...
                                            <li class="nav-item">
                                                <div class="nav-link">
                                                    <div class="d-flex align-items-center position-relative">
                                                        <div class="avatar avatar-xs">
                                                            <img class="avatar-img rounded-circle"
                                                                src="../../themes/template/assets/images/avatar/12.jpg"
                                                                alt="avatar">
                                                        </div>
                                                        <span class="ms-3">by <a href="#"
            ...
            <div class="row pt-5">
                ...
                <div class="col-md-6 col-lg-3 mb-4">
                    ...
                    <div class="mb-4 position-relative">
                        <div><a href="#" class="badge bg-danger mb-2"><i
                                    class="fas fa-circle me-2 small fw-bold"></i>Business</a></div>
                    ...
                    <!-- Item -->
                    <div class="mb-4 position-relative">
                        <div><a href="#" class="badge bg-info mb-2"><i
                                    class="fas fa-circle me-2 small fw-bold"></i>Marketing</a></div>
                        ...
                        <ul class="nav nav-divider align-items-center small mt-2 text-muted">
                            <li class="nav-item position-relative">
                                <div class="nav-link">by <a href="#"
                                        class="stretched-link text-reset btn-link">Larry</a>
                                </div>
                            </li>
                ...
                <div class="col-sm-6 col-lg-3 mb-4">
                    ...
                    <div class="row g-2">
                        <div class="col">
                            <a href="#"><img class="w-100" src="../../themes/template/assets/images/app-store.svg"
                                    alt="app-store"></a>
                        </div>
                        <div class="col">
                            <a href="#"><img class="w-100" src="../../themes/template/assets/images/google-play.svg"
                                    alt="google-play"></a>
                        </div>
                    </div>
                </div>
        ...
        <div class="bg-dark-overlay-3 mt-5">
            <div class="container">
                <div class="row align-items-center justify-content-md-between py-4">
                    <div class="col-md-6">
                        <!-- Copyright -->
                        <div class="text-center text-md-start text-primary-hover text-muted">©2021 <a
                                href="https://www.webestica.com/" class="text-reset btn-link"
