    ...
    <div class="row clearfix">
        ...
        <div class="col-xl-8 col-lg-8 col-md-8">
            ...
            <div class="row">
                <div class="col-md-6">
                    <h5>
                        <dt>กลุ่มผู้ใช้งาน <small>(<?=number_format($count_user_group);?> รายการ)</small></dt>
                    </h5>
                </div>
                <div class="col-md-6 text-right">
                    <a class="btn btn-success" href="index.php?r=user-group%2Fcreate_usergroup"><i class="fe fe-plus"
                            data-toggle="tooltip" title="" data-original-title="fe fe-plus"></i> เพิ่มกลุ่มผู้ใช้งาน</a>
                </div>
            </div>
            ...
            <input type="text" name="search_box" id="search_box" class="form-control"
                placeholder="ค้นหา (ชื่อกลุ่มผู้ใช้งาน , รายละเอียด)" />
