  ...
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="exampleModalLabel"><div id="setting_name"></div></h5>
        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
          <span aria-hidden="true">&times;</span>
        </button>
      </div>
      <div class="modal-body">
          <input type="text" class="form-control" id="setting_value"  style="width:100%">
      </div>
            ...
            <div class="container-fluid">              
                ...
                <div class="row clearfix row-deck">
                    <div class="col-lg-6 col-md-12">
                        <div class="card">
                            <div class="card-header">
                                <h3 class="card-title">ตั้งค่า Server</h3>
                                <div class="card-options">
                                </div>
                            </div>
                            <div class="card-body">
                            <?  foreach($Setting as $s){ ?>
                                ...
                                <strong><?=$s->setting_name?></strong> : <?=$s->setting_value?>   
                                [<a  href="index.php?r=setting/update&id=<?=$s->id?>">แก้ไข</a>]

                                <!-- [<a data-toggle="modal" data-target="#exampleModal" onClick="sendSetting('<?=$s->setting_name?>','<?=$s->setting_value?>')" href="#">แก้ไข</a>] -->
                            ...
                            <a href="index.php?r=setting" class="btn btn-primary">ตั้งค่า</a>
