...
<style>
.grid-view>table.table th:last-child,
        ...
        <div class="col-lg-3 col-md-6">
            <div class="card" style="font-size: 100%;">
                <div class="card-body" style="font-size: 100%;">
                    ...
                    <h4 class="mb-1"><span
                            class="countAll"><?php echo number_format($count_zdi = Yii::$app->db->createCommand("SELECT COUNT(*) FROM eform_data WHERE form_id = '21' ORDER BY id ASC")->queryScalar()); ?></span>
                    </h4>
                    <div>ผกร. ทั้งหมด</div>
                    <div class="mt-4">
        ...
        <div class="col-lg-3 col-md-6">
            <div class="card" style="font-size: 100%;">
                <div class="card-body" style="font-size: 100%;">
                    ...
                    <h4 class="mb-1"><span
                            class="sumToDay"><?php echo number_format($count_Terrorist_type = Yii::$app->db->createCommand("SELECT COUNT(*) FROM Terrorist_type ORDER BY id ASC")->queryScalar()); ?>
                        </span></h4>
            ...
            <div class="card <?php echo $culor;?>">
                <div class="card-body ribbon">
                    ...
                    <?php if ($_SESSION['user_role']=='3'): ?>
                        <p style="float:right;">
                            <a href="index.php?r=site/pages&view=eform_information&form_id=<?=$id;?>"
                                class="btn btn-lg btn-outline-danger"> <i class="fa fa-plus-circle"></i> เพิ่มข้อมูล</a>
                            <a href="index.php?r=site/pages&view=eform_information&form_id=<?=$id;?>"
                                class="btn btn-lg btn-outline-success"> <i class="fa fa-signal"></i> dashboard</a>
                        </p>
                    <?php endif ?>
                    <?php endif ?>
