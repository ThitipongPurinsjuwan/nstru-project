			...
			<?php if (isset($_GET['printnow'])): ?>
				...
				function show_preview_design(){
					...
					$.each(data, function(i) {
						...
						if (data[i].type==3) {
							var checkheight = $("#show-preview22").height();
							// console.log(checkheight);
							
							$data_show = `
							<div class="col-md-12 page-break" style="height: 10px; page-break-before:always;"></div>
							`;
							...
							<div class="card-border show-map map-container" id="${name_div}" style="width: 100%; height: 400px;">
							</div>
							</div>
