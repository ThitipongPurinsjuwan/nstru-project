	...
	<div class="col-6 col-md-4 col-xl-4">
		<div class="card card-primary ">
			<div class="card-body card-height">
				<div class="row">
					<div class="col-md-6">
						<?php $count_equipment_sn = Yii::$app->db->createCommand("SELECT COUNT(*) FROM equipment_sn WHERE id_main = '".$equipment['id']."' ORDER BY id ASC")->queryScalar(); ?>
						<div class="equipment-views-title">
							จำนวนเครื่องทั้งหมด
						</div>
						<div class="equipment-views-box">
							<div class="equipment-views-count"><?=$count_equipment_sn;?></div>
							<div class="equipment-views-pronoun"><?php echo $equipment['pronoun']; ?></div>
						</div>
					</div>
					<div class="col-md-6">
						<?php $count_equipment_dis = Yii::$app->db->createCommand("SELECT COUNT(*) FROM equipment_sn WHERE id_main = '".$equipment['id']."' AND status = 1 ORDER BY id ASC")->queryScalar(); ?>
						<div class="equipment-views-title">อยู่ในระหว่างการเบิกจ่าย</div>
						<div class="equipment-views-box">
							<div class="equipment-views-count"><?=$count_equipment_dis;?></div>
							<div class="equipment-views-pronoun"><?php echo $equipment['pronoun']; ?></div>
						</div>
					</div>
				</div>
