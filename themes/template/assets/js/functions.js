    ...
    darkMode: function() {
        ...
        if (e.isVariableDefined(dark)) {
            ...
            dms.addEventListener("click", function() {
                if (dir == 'rtl') {
                    if (style.getAttribute('href') == '../../themes/template/assets/css/style-rtl.css') {
                        style.setAttribute('href', '../../themes/template/assets/css/style-dark-rtl.css');
                    } else {
                        style.setAttribute('href', '../../themes/template/assets/css/style-rtl.css');
                    }
                } else {
                    if (style.getAttribute('href') == '../../themes/template/assets/css/style.css') {
                        style.setAttribute('href', '../../themes/template/assets/css/style-dark.css');
                    } else {
                        style.setAttribute('href', '../../themes/template/assets/css/style.css');
                    }
                }
